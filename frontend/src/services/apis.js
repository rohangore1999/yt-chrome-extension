...
export const queryTranscript = async (query) => {
  try {
    ...
    // const data = {
    //   response: `### Building Blocks of Protein Powder\n\nAccording to the video, protein powder consists of five main building blocks:\n\n*   **Protein Source:** The primary ingredient, for which the video uses a
    //     whey concentrate from Europe. [00:04]\n*   **Taste:** The video uses real cocoa from Ivory Coast and Ghana instead of artificial or natural flavors. [00:10]\n*   **Sweetening System:** To add
    //     sweetness, the video uses Stevia, a natural sweetener. [00:27]\n*   **Mixing Agent:** To ensure the powder mixes well with water, a natural sunflower lecithin is used. [00:45]\n*   **Color:** The
    //     video notes that color is an optional block and they have chosen not to add any. [00:51]`,
    //   success: true,
    //   timestamps: [
    //     {
